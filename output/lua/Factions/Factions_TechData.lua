...
kModdedTechData =
{
	...
	{ [kTechDataId] = kTechId.HandheldRailgun,  [kTechDataTooltipInfo] = "RAILGUN_TOOLTIP", [kTechDataPointValue] = kWeaponPointValue,    [kTechDataMapName] = HandheldRailgun.kMapName, [kTechDataDisplayName] = "HANDRAILGUN",         [kTechDataModel] = HandheldRailgun.kModelName, [kTechDataDamageType] = kHandheldRailgunDamageType, [kTechDataCostKey] = kHandheldRailgunCost, },
	...
	{ [kTechDataId] = kTechId.RailgunSentry, 	[kTechDataBuildMethodFailedMessage] = "COMMANDERERROR_TOO_MANY_SENTRIES",      [kTechDataHint] = "SENTRY_HINT", [kTechDataGhostModelClass] = "MarineGhostModel", [kTechDataMapName] = RailgunSentry.kMapName,                   [kTechDataDisplayName] = "SENTRY_TURRET",       [kTechDataCostKey] = kSentryCost,         [kTechDataPointValue] = kSentryPointValue, [kTechDataModel] = RailgunSentry.kModelName,            [kTechDataBuildTime] = kSentryBuildTime, [kTechDataMaxHealth] = kSentryHealth,  [kTechDataMaxArmor] = kSentryArmor, [kTechDataDamageType] = kSentryAttackDamageType, [kTechDataSpecifyOrientation] = true, [kTechDataHotkey] = Move.S, [kTechDataInitialEnergy] = kSentryInitialEnergy,      [kTechDataMaxEnergy] = kSentryMaxEnergy, [kTechDataNotOnInfestation] = true, [kTechDataEngagementDistance] = kSentryEngagementDistance, [kTechDataTooltipInfo] = "SENTRY_TOOLTIP", [kStructureBuildNearClass] = "SentryBattery", [kStructureAttachRange] = SentryBattery.kRange, [kTechDataBuildRequiresMethod] = GetCheckSentryLimit, [kTechDataAllowConsumeDrop] = true, [kTechDataMaxAmount] = kNumRailgunSentriesPerPlayer },
