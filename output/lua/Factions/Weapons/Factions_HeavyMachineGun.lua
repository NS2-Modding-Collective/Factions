...
class 'HeavyMachineGun' (Rifle)

HeavyMachineGun.kMapName = "hmg"

HeavyMachineGun.kModelName = PrecacheAsset("models/marine/lightmachinegun/lightmachinegun.model")
...
HeavyMachineGun.kIronSightTexture = "ui/Factions/testing_ironsights.png"
HeavyMachineGun.kIronSightZoomFOV = 80
HeavyMachineGun.kIronSightActivateTime = 0.1

HeavyMachineGun.kLaserSightWorldModelAttachPoint = "fxnode_riflemuzzle"
HeavyMachineGun.kLaserSightViewModelAttachPoint = "fxnode_riflemuzzle"
