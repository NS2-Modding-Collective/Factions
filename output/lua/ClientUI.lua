...
kShowAsClass["Exo"] = { GUIExoThruster = true, ["Hud/Marine/GUIMarineHUD"] = true, ["Hud/Marine/GUIExoHUD"] = true, GUIProgressBar = true, GUIRequestMenu = true, GUIWaypoints = true, GUIExoEject = true, ["Factions/Hud/Factions_GUIExperienceBar"] = true }
...
kShowAsClass["Alien"] = { GUIObjectiveDisplay = true, GUIProgressBar = true, GUIRequestMenu = true, GUIWaypoints = true, GUIAlienHUD = true,
                          GUIEggDisplay = true, GUIRegenerationFeedback = true, ["Factions/Hud/Factions_GUIExperienceBar"] = true, GUIUpgradeChamberDisplay = true, GUIAuraDisplay = true }
